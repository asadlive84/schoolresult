    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('std_class', models.CharField(max_length=50, verbose_name='Student Class')),
                ('std_roll', models.IntegerField(help_text='Type Student Roll Number (Only Number)', verbose_name='Roll Number')),
                ('std_group', models.CharField(max_length=50, verbose_name='Group')),
                ('std_gender', models.CharField(max_length=50, verbose_name='Gender')),
                ('std_total_marks', models.FloatField(default=0, verbose_name='Total Marks')),
                ('std_gpa', models.CharField(max_length=10, verbose_name='GPA')),
            ],
            bases=('results.stdcommon',),
        ),
        migrations.CreateModel(
